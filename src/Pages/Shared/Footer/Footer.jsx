...
const Footer = () => {
    ...
    const first3Courses = courses.slice(0, 4);
    return (
        // <div className="">
            <div className="">
                <footer className="relative mt-16" style={{
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 text-white p-10 relative max-w-screen-lg mx-auto gap-8 md:gap-32" >
                        {/* Column 1 */}
                        <div className="border-b-2 border-gray-500 pb-4 md-pb-0 md:border-b-0">
                            <div>
                                <img src="https://i.ibb.co.com/L8DNcxJ/Logo-2.png" alt="logo" className="w-28" />
                                <p className="md:w-56 mb-4">Our Cooking School features a long and proud history of more than 100 years. Founded at the end of the XIXth century.</p>
                        ...
                        {/* Column 3 */}
                        <div>
                            <nav className="md:mb-0 mb-4  grid grid-cols-1  border-b-2 border-gray-500 pb-4 md-pb-0 md:border-b-0">
                                <h6 className="text-lg font-semibold text-white mb-2">Explore</h6>
                                <a className="link link-hover">About us</a>
                                <a className="link link-hover">Contact</a>
                                <a className="link link-hover">Jobs</a>
                            </nav>
                            <nav className="md:mb-0 mb-4 border-b-2 border-gray-500 pb-4 md-pb-0 md:border-b-0">
